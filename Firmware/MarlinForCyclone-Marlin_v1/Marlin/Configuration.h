...
#define HOMING_FEEDRATE {300, 300, 100, 0}  // set the homing speeds (mm/min)
...
#define DEFAULT_MAX_ACCELERATION      {1,1,1, 50}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for skeinforge 40+, for older versions raise them a lot.
#define DEFAULT_ACCELERATION          2     // X, Y, Z and E max acceleration in mm/s^2 for printing moves 
#define DEFAULT_RETRACT_ACCELERATION  200   // X, Y, Z and E max acceleration in mm/s^2 for r retracts
